...
Example:
    from dexim_core.nodes import TeleopNode
...
class TeleopNode(HardwarePublisherNode):
    ...
    def _apply_velocity_limiting(self, target_joints: np.ndarray) -> np.ndarray:
        ...
        """
        # TODO: TEMPORARILY DISABLED FOR DEBUGGING - REMOVE THIS
    ...
    def _smootherstep(t: float) -> float:
        ...
        and acceleration at the boundaries (t=0 and t=1).
